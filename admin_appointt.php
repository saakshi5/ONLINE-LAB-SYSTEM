...
function search(e){
          ...
          let s=document.getElementById("search");
            ...
            console.log(n);
            n=n.toLowerCase();
    const tt =document.getElementById('addappointbox');
    const ts =document.getElementById('appointsearch');
...
btn3.addEventListener('click',e=>opennn(e));
    ...
    //rows and cols
     let tbox1=document.getElementById('addappointbox');
